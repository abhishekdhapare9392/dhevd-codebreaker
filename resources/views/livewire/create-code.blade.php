<div class="my-8 flex flex-col items-center gap-10 flex-1">
    <form class="print:hidden w-full">
        <textarea wire:model.live='message' cols="30" rows="10"
            class="bg-white/10 text-white rounded-lg px-4 py-2 w-full"></textarea>
        <div class="mt-2 flex justify-end">
            <button type="button" @disabled(! $message) @click="window.print()"
                class="bg-blue-500 px-2 py-1 text-sm font-semibold rounded-md disabled:bg-gray-400">Print</button>
        </div>
    </form>
